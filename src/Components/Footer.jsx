...
function Footer() {
  ...
  return (
    <div className="footer">
      <h1>
        <span className="white">Anim</span>Xer
      </h1>
      <p className="footer-about">
        AnimXer is not affiliated with or endorsed by any of the anime studios
        ...
        AnimXer never downloads the video from any source provider, link will
